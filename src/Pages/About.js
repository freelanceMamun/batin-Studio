    ...
    <>
      ...
      <section className="section">
        <div className="lg:flex">
          ...
          <div className="my-paragraph text-center sm:text-left
          lg:w-[60%]">
            We are a digital product design and development agency. In our team, developers work alongside designers, strategists and analysts. We
            don't do cookie-cutter solutions and we build
            ...
            drives productivity and increases revenue. Our
            expertise and ingenuity are remarkable, yet we always strive to outdo and outperform our
