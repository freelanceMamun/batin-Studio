...
const Nav = () => {
  ...
  return (
    <>
      <div className="navMain my-font flex justify-between w-[90%] relative z-50 h-[72px] rounded-full backdrop-blur-[34px] px-[25px] bg-transparent mx-auto mt-5">
        <Link to="/">
              ...
              <ul className='flex flex-col gap-[16px] list-none'>
                ...
                <li className='nav-lg-font pt-[16px]'>
                  <div className='h-[100px] w-[100px] bg-black rounded-full relative'>
                    <Link className='absolute top-[15px] relative'><span className='text-white duration-700'>Portf</span>olio
